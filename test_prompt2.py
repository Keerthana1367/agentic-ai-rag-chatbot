...
SYSTEM_PROMPT = (
    ...
    "8. If the user asks for a specific number of items (e.g., 6) but the context only contains\n"
    "   some of them (e.g., 5), DO NOT REFUSE. You MUST list the items you found and state that\n"
